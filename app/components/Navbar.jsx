      ...
      <div className="gap-6 items-center px-6 md:px-3 flex   ">
        <div className="flex gap-5 items-end justify-end ">
          <NavLink className="flex md:flex" href="/about">
            <span className="relative z-10 block px-3 py-3 overflow-hidden font-medium leading-tight text-black transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
