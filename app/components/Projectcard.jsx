...
export default function ProjectCard({ name, image, link }) {
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3 w-[6px] h-[6px] rounded-full bg-text-muted z-10" />
      <div className="absolute top-3 right-3 w-[6px] h-[6px] rounded-full bg-text-muted z-10" />
      <div className="absolute bottom-3 left-3 w-[6px] h-[6px] rounded-full bg-text-muted z-10" />
